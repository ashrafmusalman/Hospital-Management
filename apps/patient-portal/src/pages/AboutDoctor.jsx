...
import { DoctorHeroSkeleton, DoctorProfileBodySkeleton } from "../components/Skeleton";
  ...
  return (
    <div className="ad-root">
          ...
          {!loading && !error && doctor && (
            <div className="hero-profile">
              ...
              <div className="photo-frame" style={{ background: `linear-gradient(135deg,${c1}33,${c2}33)` }}>
                {hasImg ? (
                  <ImageWithSkeleton src={imgUrl} alt={doctor.name} onError={() => setImgErr(true)} />
                ) : (
      ...
      <div className="body-wrap">
        ...
        {/* Loading */}
        {loading && <DoctorProfileBodySkeleton />}
        ...
        {!loading && !error && doctor && (
          <>
            ...
            <div className="profile-grid">
              ...
              {/* ── LEFT COLUMN ── */}
              <StaggerGroup style={{ display:"flex", flexDirection:"column", gap:20 }} stagger={0.1}>
                  ...
                  <div className="panel-body">
                    <div className="contact-rows">
                      {[
                        ...
                        <motion.div key={c.label} className="contact-row" whileHover={{ x: 4 }}>
