          ...
          <div className="doctor-list">
            ...
            {loading && (
              <div className="state-box">
                ...
                <div className="state-title">Loading doctors from database…</div>
            ...
            {!loading && !error && filteredDoctors.map((doc,i)=>{
              ...
              return (
                <div key={doc.id} className={`doc-card ${isSelected?"selected":""}`} style={{animationDelay:`${i*.045}s`}}>
                  {/* Color strip */}
                  ...
                  <div className="doc-avatar-wrap">
                    <div className="doc-avatar" style={{background:`linear-gradient(135deg,${c1},${c2})`}}>
                      {doc.image
                        ? <img src={getImg(doc.image)} alt={doc.name} onError={e=>e.currentTarget.style.display="none"}/>
