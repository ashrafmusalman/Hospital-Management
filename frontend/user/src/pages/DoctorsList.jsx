...
function DoctorsList() {
  ...
  const grad = (i) => GRAD[i % GRAD.length];
    ...
    <div className="dl-shell">
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        /* ── PAGE HERO ── */
        .page-hero {
          background: linear-gradient(135deg, #0c1a0e 0%, #14532d 60%, #052e16 100%);
          padding: 72px 5% 80px; position: relative; overflow: hidden;
        }
        .page-hero::before {
        ...
        .hero-eyebrow {
          ...
          color:rgba(74,222,128,.8); margin-bottom:16px;
        }
        .hero-eyebrow::before { content:''; width:20px; height:2px; background:currentColor; border-radius:2px; }
        .hero-title {
          font-family:'Fraunces',serif;
          font-size:clamp(2rem,4vw,3.2rem); font-weight:900;
          color:#fff; letter-spacing:-.04em; line-height:1.05; margin-bottom:14px;
        }
        ...
        .search-bar-btn {
          background:var(--g); border:none; border-radius:10px; padding:10px 20px;
          color:#fff; font-size:13.5px; font-weight:700; font-family:'DM Sans',sans-serif;
        ...
        .doc-card:hover { border-color:rgba(22,163,74,.3); box-shadow:0 8px 28px rgba(22,163,74,.10); transform:translateY(-2px); }
        ...
        .doc-avatar {
          ...
          font-family:'Fraunces',serif; font-size:20px; font-weight:900; color:#fff;
          border:2px solid rgba(255,255,255,.2);
        }
        .doc-main { flex:1; min-width:0; }
        .doc-name { font-size:16px; font-weight:700; color:var(--ink); margin-bottom:5px; line-height:1.2; }
        .doc-spec {
          display:inline-flex; align-items:center; gap:5px;
          background:var(--g-xl); color:var(--g-d);
          font-size:11.5px; font-weight:700; padding:3px 11px; border-radius:999px;
        }
        .selected-badge {
          flex-shrink:0; display:flex; align-items:center; justify-content:center;
          width:28px; height:28px; border-radius:50%;
          background:var(--g); color:#fff; font-size:14px;
        }
        ...
        .meta-pill span:first-child { font-size:14px; }
        ...
        .btn-select {
          flex:1; padding:11px 16px; border-radius:11px; font-size:13.5px; font-weight:700;
          font-family:'DM Sans',sans-serif; cursor:pointer; transition:all .18s; border:none;
        }
        ...
        .btn-profile {
          ...
          background:var(--white); color:var(--ink2); border:1.5px solid var(--border);
        ...
        .no-selection {
          ...
          font-size:13px; color:var(--ink3); margin-bottom:18px;
        ...
        .btn-book {
          ...
          background:var(--g); color:#fff; font-size:14.5px; font-weight:700;
          font-family:'DM Sans',sans-serif; cursor:pointer;
          transition:all .2s; box-shadow:var(--shadow-green); margin-bottom:20px;
        }
        ...
        @media (max-width:640px) {
          .page-hero   { padding:52px 5% 64px; }
          .main-body   { padding:24px 5% 48px; }
          .hero-stats  { gap:20px; }
      ...
      <div className="page-hero">
        <div className="hero-inner">
          ...
          <h1 className="hero-title">
            Find the <em>right specialist</em><br />for your care
          </h1>
          <p className="hero-sub">
            Browse our team of expert physicians. Search by name or specialization, select your doctor, and book your appointment in seconds.
          </p>
          ...
          <div className="hero-stats">
            {[
              ...
              { num: "18+",  lbl: "Years of Excellence" },
              { num: "24/7", lbl: "Emergency Care" },
            ].map((s, i) => (
              <>
                {i > 0 && <div key={`div-${i}`} className="hero-stat-div" />}
        ...
        {!loading && !error && (
          <div className="filter-row">
            ...
            {specializations.map(s => (
              <button
                key={s}
                className={`filter-chip ${filterSpec === s ? "active" : ""}`}
          ...
          <div className="doctor-list">
            ...
            {loading && (
              <div className="state-box">
                ...
                <div className="state-sub">Fetching available specialists, one moment.</div>
              </div>
            )}
                ...
                >
                  ...
                  <div className="card-top">
                    ...
                    <div className="doc-main">
                      ...
                      <span className="doc-spec">🔬 {doc.specialization || "Specialist"}</span>
                    </div>
                  ...
                  <div className="card-meta">
                    <div className="meta-pill"><span>🪪</span> ID #{doc.id}</div>
                    {doc.consultation_fee != null && (
                      <div className="meta-pill"><span>💳</span> ₹ {doc.consultation_fee}</div>
                    )}
                    {doc.experience != null && (
                      <div className="meta-pill"><span>🏅</span> {doc.experience} yrs exp</div>
                    )}
                  </div>
                  ...
                  <div className="card-actions">
                    ...
                    <Link to={`/dashboard/doctors/${doc.id}`} className="btn-profile">
                      View Profile →
                    </Link>
                  </div>
                </div>
