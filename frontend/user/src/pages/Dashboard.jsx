    ...
    <div className="mc">
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .feat-icon{width:46px;height:46px;border-radius:13px;flex-shrink:0;background:var(--g-xl);border:1px solid rgba(34,197,94,.2);display:flex;align-items:center;justify-content:center;font-size:20px;}
      ...
      <div className="stats-band" ref={statsRef}>
        <div className="inner">
          <div className="stats-grid">
            {STATS.map(s=><StatItem key={s.lbl} {...s} inView={inView}/>)}
          </div>
        </div>
      </div>
        ...
        <div className="inner">
          <div className="about-grid">
            <div>
              ...
              <p className="sec-sub" style={{marginBottom:32}}>Gujarat's first NABH-accredited private hospital with over 18 years of excellence in patient care.</p>
              {[
            ...
            <div className="blog-grid">
              {BLOGS.slice(1).map(b=>(
                <div className="blog-row" key={b.title}>
                  <div className="blog-thumb"><img src={b.img} alt={b.title} onError={e=>e.currentTarget.style.display="none"}/></div>
