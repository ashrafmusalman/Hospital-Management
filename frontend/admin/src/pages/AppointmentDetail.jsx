    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .appt-page { min-height:100vh; background:#060b18; font-family:'Sora',sans-serif; position:relative; overflow-x:hidden; }
        ...
        .btn-complete{
          ...
          color:#fff;font-size:14.5px;font-weight:700;font-family:'Sora',sans-serif;
